...
**This is shadcn/ui, built on Base UI.**
...
## Same Philosophy, Different Foundation
...
Ready to use shadcn/ui components with Base UI's foundation? Browse the component documentation to see the implementations and examples.

Each component page includes:
- **Easy Installation:** Install any component with just a single command using shadcn CLI
