    ...
    <div className="flex items-center gap-2 flex-wrap">
        ...
        <DrawerContent className="max-w-lg mx-auto">
          ...
          <ul className="mt-5 space-y-2 text-sm text-left">
            <li className="rounded-md border p-3">
              ...
              <p className="text-muted-foreground text-xs mt-0.5">2 min ago</p>
            </li>
            <li className="rounded-md border p-3">
              <p className="font-medium">Deployment succeeded</p>
              <p className="text-muted-foreground text-xs mt-0.5">15 min ago</p>
            </li>
            <li className="rounded-md border p-3">
      ...
      <Drawer swipeDirection="right">
        ...
        <DrawerContent>
          ...
          <DrawerDescription>Task information and metadata.</DrawerDescription>
